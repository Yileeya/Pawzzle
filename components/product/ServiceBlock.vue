  ...
  <div class="service-block">
    ...
    <div class="service-content">
      ...
      <div class="box">
        ...
        <ul>
          <li v-for="(describe, idx) in pageService.describe" :key="`${pageService.name}_describe_${idx}`">{{ describe }}</li>
        </ul>
      </div>
    </div>
    <div v-if="pageService.has_bath_products" class="bath-products">
